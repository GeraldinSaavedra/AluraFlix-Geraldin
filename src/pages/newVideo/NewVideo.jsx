...
function NewVideo() {
    ...
    const validateFormAndSetErrors = async () => {
        ...
        console.log(formErrors);  // Agregar este log para depurar
    ...
    const handleConfirmSave = () => {
        const newVideo = { ...formData, id: Date.now() };  // Genera un id basado en el tiempo
        addVideo(newVideo);
        setNotificationMessage('El video ha sido añadido con exito.');
